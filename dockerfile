...
CMD ["gunicorn", "--worker-class", "geventwebsocket.gunicorn.workers.GeventWebSocketWorker", "--workers", "1", "--threads", "10" ,"--worker-connections", "1000", "--bind", "0.0.0.0:3440", "search:app"]
